...
#set init_pwr_net "VDD top/mips/VDD top/imem/VDD top/dmem/VDD"
set init_pwr_net {VDD VDD_SW}
set init_gnd_net VSS
#set power_intent_file "../../syn/outputs/top_genus_upf.upf"
set power_intent_file "../../syn/upf/upf_one_domain.upf"
...
#echo create_rc_corner -name cmax -T -40 -pre_route_cap 1.0 -pre_route_res 1.0 -post_route_cap 1.0 -post_route_res 1.0 >> mmmc.tcl
...
create_floorplan -site unit -core_size {10 10 10 10 10 10}
...
#add_power_switches -power_domain PD_TOP -global_switch_cell_name HEADX2_RVT -1801power_switch_rule_name SW_CPU -column -horizontal_pitch 50 -no_double_height_check -top_offset 3

add_ring -type core_rings -nets {VDD VSS} -layer {top M7 bottom M7 left M8 right M8} -offset 1 -width 0.2 -spacing 1.0 -follow core

deselect_obj -all
select_obj PD_TOP
# TODO: Add stripes over pins only, set appropriate option
#add_stripes -nets {VDD} -direction vertical -layer M7 -master *HEADX2* -width 1  -over_power_domain 1 -spacing 12.5 -start_offset 0 -set_to_set_distance 25 -over_pins 1
...
route_special -nets {VDD VSS} -allow_layer_change 1 -allow_jogging 1 -core_pin_target {stripe ring block_ring} -block_pin_target {nearest_target} -connect {block_pin pad_pin pad_ring core_pin floating_stripe} 
